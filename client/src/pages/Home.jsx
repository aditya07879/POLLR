            ...
            <div className="home-bar-track">
              <div
                ...
                style={{
                  width: `${opt.pct}%`,
                  background:
                    opt.votes === max ? "linear-gradient(90deg,#6366f1,#8b5cf6)" : "#e4e4e7",
    ...
    <div className="home-root">
      <nav className="home-nav">
        <div className="home-nav-inner">
          ...
          <div className="home-nav-links">
            ...
            <a href="#love" className="home-nav-link">
              Testimonials
            </a>
            ...
            {user ? (
              <Link to="/create" className="home-nav-cta">
                Create poll →
              </Link>
            ) : (
      ...
      <section className="home-hero">
        ...
        >
          ...
          <p className="home-subhead">
            Create a poll in seconds. Share one link. Watch votes roll in live — no refresh
            required. Built for teams that move at the speed of decisions.
          </p>
          ...
          <div className="home-hero-trust">
            <div className="home-trust-avatars">
              {["A", "B", "C", "D", "E"].map((l, i) => (
                <div key={l} className="home-trust-av" style={{ marginLeft: i ? -10 : 0 }}>
                  {l}
                </div>
              ))}
            </div>
      ...
      <section className="home-how-section" id="how">
        <div className="home-section-inner">
          ...
          <p className="home-section-sub">From idea to insights in under a minute.</p>
          <div className="home-steps">
            <Step
              n="01"
              delay={0}
              title="Write your question"
              desc="Type your question, add up to 6 answer options, and set an expiry time. Takes about 20 seconds."
            />
            <div className="home-step-arrow" aria-hidden>
              →
            </div>
            <Step
              n="02"
              ...
              desc="Copy your poll's unique URL and drop it anywhere — no account required for voters."
            />
            <div className="home-step-arrow" aria-hidden>
              →
            </div>
            <Step
              ...
              desc="The results page updates in real-time as votes pour in. Share the results link too."
            />
          </div>
        </div>
      </section>
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderRadius: 99,
                          background:
                            i === 0 ? "linear-gradient(90deg,#6366f1,#8b5cf6)" : "#e4e4e7",
            ...
            <div className="home-bento-card home-bento-sm">
              ...
              <div className="home-platform-icons">
                {["Slack", "Email", "Tweet", "QR"].map((p) => (
                  <span key={p} className="home-platform-chip">
                    {p}
                  </span>
                ))}
              </div>
        ...
        <div className="home-section-inner">
          ...
          <div className="home-testimonials">
            <Testimonial
              ...
              avatar="PG"
              name="Piyush Garg"
              role="Principal Engineer, Oraczen "
              quote="We run weekly team polls for retros and sprint planning. Results show up before everyone's even voted — it's magic."
            />
            <Testimonial
              delay={100}
              avatar="HC"
              ...
              role="CEO , ChaiCode"
              quote="I've tried every polling tool. Pollr is the only one that doesn't feel like a form from 2012. The live bar animations are Best"
            />
            <Testimonial
              delay={200}
              avatar="A"
              name="Anirudh"
              role="CTO, Raycast"
              quote="Set up a company-wide poll in 30 seconds. 400 votes in the first hour. The countdown timer keeps urgency high."
            />
          </div>
        </div>
      </section>
        ...
        <div className="home-footer-inner">
          <div className="home-footer-brand">
            <Link to="/" className="home-nav-logo" style={{ marginBottom: 10 }}>
              <span className="home-logo-mark" style={{ width: 26, height: 26, fontSize: 12 }}>
                P
              </span>
              Pollr
            </Link>
          ...
          <div className="home-footer-links">
            <div className="home-footer-col">
              ...
              <a href="#features" className="home-footer-link">
                Features
              </a>
              <a href="#how" className="home-footer-link">
                How it works
              </a>
              <Link to="/signup" className="home-footer-link">
                Sign up free
              </Link>
            </div>
            <div className="home-footer-col">
              ...
              {user ? (
                <Link to="/dashboard" className="home-footer-link">
                  Dashboard
                </Link>
              ) : (
                <>
                  <Link to="/signin" className="home-footer-link">
                    Login
                  </Link>
                  <Link to="/signup" className="home-footer-link">
                    Register
